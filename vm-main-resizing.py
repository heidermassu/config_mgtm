...
# Perform actions creating new nic, aataching new nic to old vm and attaching prod nic to new vm
    nic_attach (target_resource_group, rg_vnet, resource_group_name, vm_name, new_vm_name, subscription_id, nic_name, vnetnet_id, subnet_id, ip_configuration_name, private_ip_address_allocation)
