from common.vm.disk import create_vm_snapshot, create_disk_from_snap, initialize_variables
...
new_disk_name = '' # Diskname name going to be created
new_vm_name = '' # New VM name going to be created
vm_size = 'Standard_D8s_v5'  # Replace with the desired VM size
...
subnet_id = "" # subnet ID where is the NIC that want to be detached and also where going to be created new nic temp. Obs both have to be same VNET
vnetnet_id = "" # VNET ID where is the NIC that want to be detached and also where going to be created new nic temp. Obs both have to be same VNET
